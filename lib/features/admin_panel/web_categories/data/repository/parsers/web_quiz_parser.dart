...
import 'package:dtmtest/features/admin_panel/web_categories/data/repository/parsers/quiz_parser.dart';
...
class WebQuizParser implements QuizParser {
  ...
  List<Question> parseQuestions(String htmlContent) {
    ...
    for (var element in elements) {
      ...
      int optionStartIndex = lines
          .indexWhere((line) => RegExp(r'^[A-D]\)\s').hasMatch(line.trim()));
