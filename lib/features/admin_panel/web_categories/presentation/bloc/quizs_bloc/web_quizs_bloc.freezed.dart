...
mixin _$WebQuizsState {
  ...
  @JsonKey(ignore: true)
  $WebQuizsStateCopyWith<WebQuizsState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WebQuizsStateCopyWith<$Res> {
  factory $WebQuizsStateCopyWith(
          WebQuizsState value, $Res Function(WebQuizsState) then) =
      _$WebQuizsStateCopyWithImpl<$Res, WebQuizsState>;
  @useResult
  $Res call(
...
/// @nodoc
class _$WebQuizsStateCopyWithImpl<$Res, $Val extends WebQuizsState>
    implements $WebQuizsStateCopyWith<$Res> {
  _$WebQuizsStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$WebQuizsStateImplCopyWith<$Res>
    implements $WebQuizsStateCopyWith<$Res> {
  factory _$$WebQuizsStateImplCopyWith(
          _$WebQuizsStateImpl value, $Res Function(_$WebQuizsStateImpl) then) =
      __$$WebQuizsStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {BlocStatus addCategoryStatus,
...
/// @nodoc
class __$$WebQuizsStateImplCopyWithImpl<$Res>
    extends _$WebQuizsStateCopyWithImpl<$Res, _$WebQuizsStateImpl>
    implements _$$WebQuizsStateImplCopyWith<$Res> {
  __$$WebQuizsStateImplCopyWithImpl(
      _$WebQuizsStateImpl _value, $Res Function(_$WebQuizsStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WebQuizsStateImpl(
      addCategoryStatus: null == addCategoryStatus
          ? _value.addCategoryStatus
          : addCategoryStatus // ignore: cast_nullable_to_non_nullable
              as BlocStatus,
...
class _$WebQuizsStateImpl extends _WebQuizsState {
  const _$WebQuizsStateImpl(
  ...
  @override
  String toString() {
    return 'WebQuizsState(addCategoryStatus: $addCategoryStatus, getAllCategoriesStatus: $getAllCategoriesStatus, deleteCategoryStatus: $deleteCategoryStatus, editCategoryStatus: $editCategoryStatus, getAllThemesStatus: $getAllThemesStatus, addNewThemeStatus: $addNewThemeStatus, editThemeStatus: $editThemeStatus, deleteThemeStatus: $deleteThemeStatus, listCategories: $listCategories, listThemes: $listThemes, message: $message)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$WebQuizsStateImplCopyWith<_$WebQuizsStateImpl> get copyWith =>
      __$$WebQuizsStateImplCopyWithImpl<_$WebQuizsStateImpl>(this, _$identity);
}

abstract class _WebQuizsState extends WebQuizsState {
  const factory _WebQuizsState(
      {final BlocStatus addCategoryStatus,
      final BlocStatus getAllCategoriesStatus,
      final BlocStatus deleteCategoryStatus,
      final BlocStatus editCategoryStatus,
      ...
      final List<CategoryModel>? listCategories,
      final List<ThemeModel>? listThemes,
      final String? message}) = _$WebQuizsStateImpl;
  const _WebQuizsState._() : super._();
